...
export function WorkshopSection() {
  return (
    <SectionShell id="workshop" className="overflow-hidden">
      ...
      <div className="grid gap-10 lg:grid-cols-[0.8fr_0.75fr_0.95fr] lg:items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.6 }} className="texture-panel p-6 md:p-9">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-5">
        {siteContent.workshop.categories.map((category) => (
          <article key={category.title} className="texture-panel min-h-40 p-5 transition-transform hover:-translate-y-1">
